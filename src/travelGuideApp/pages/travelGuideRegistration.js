  ...
  useEffect(() => {
    const fetchPartnerData = async () => {
      ...
      try {
        ...
        if (partnerDpDoc.exists()) { setDpUrl(partnerDpDoc.data().profilePicUrl || null); }
          ...
          <div className="row mt-3">
            ...
            <div className="col-md-6">
              <div className="form-check form-switch">
                ...
                <input className="form-check-input ms-3" type="checkbox" id="flexSwitchCheckChecked" onChange={(e) => setIskconMember(e.target.checked)} checked />
              </div>
            </div>
          </div>
          <div className="row mt-3">
